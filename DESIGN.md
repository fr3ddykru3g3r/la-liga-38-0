...
- **Motion:** one dial rotation and one formation reveal; reduced-motion users get immediate state changes.

This avoids generic UI by presenting probability, player-season history and formation consequences as one tactile matchday instrument rather than hiding them behind interchangeable dashboard cards.
